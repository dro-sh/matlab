...
clear pi, atan2(sqrt(3),-1)*180/pi: clear pi присваивает pi значение по умолчанию, если оно было переназначено. Как этот арктангенс в уме считать я хз
ans =
  120.0000
...
a=a’; a(3): транспонирует матрицу и выведет третий элемент (элементы хранятся по столбикам, те из пред. примера 1,2,3,4)
a =
     1     2
     3     4
     ```
